...
parser.add_argument('-t', '--text', help='Use "wacky" or "real" to generate wacky or realistic-looking form responses. Default is realistic-looking', type=str, default='real')
